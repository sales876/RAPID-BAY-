-- Copy editing only: the notification bodies and flag-reason text these
-- functions generate used em dashes. Swapped for plain punctuation. No
-- behavior change — same function signatures, same logic, just the
-- format() strings.
